...
namespace EasyMealManagementGUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<InputMeals>(sp => SessionInputMeals.GetInputMeals(sp));
            services.AddSingleton<IHttpContextAccessor, HttpContextAccessor>();
            services.AddTransient<IMealWeekRepository, EFMealWeekRepository>();
            services.AddMvc();
